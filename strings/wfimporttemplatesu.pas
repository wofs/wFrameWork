...
const
  uTemplateFormatHelpRus = '[Инит]'+wfLE
          ...
          +'ПерваяКолонка = A'+wfLE
          +';ГруппыВСтроках Да / Нет / НеИспользуется'+wfLE
          +'ГруппыВСтроках = НеИспользуется'+wfLE
          +'[Группы]'+wfLE
          +';Вариант "Группы в строках = Нет";'+wfLE
          +';Группа1...ГруппаN,'+wfLE
          +';Группа1 = A'+wfLE
          +';Так же следует указать наименовани параметров в блоке "Параметры"'+wfLE
          +';'+wfLE
          +';Вариант "Группы в строках = Да";'+wfLE
          +';Здесь требуется указать только колонку с группами'+wfLE
          +';Группа = A'+wfLE
          +'[Данные]'+wfLE
          ...
          +';В случае "ГруппыВСтроках = Да" прописать алгоритм'+wfLE
          +';распознавания групп.'+wfLE
          +';Доступные варианты:'+wfLE
          +';ГруппаЕсли = Фон+ЛюбаяКолонкаКотораяДолжнаБытьПустой'+wfLE
          +';ГруппаЕсли = Фон+Цена';
