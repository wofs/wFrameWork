...
uses
  ...
  wfPQConnection, wfODBCConnection, wfPoolConnections, wfBase, wfSQLQuery, wfSQLScript, wfSQLTransaction, wfTreeView, 
  wfDBGrid, wfComboBox, wfStatusProgressBar, wfReport, wfImport, wfSettings, wfEntity, wfSQLStrings, 
  wfValueListEditor, TwfProgressU, wfReportViewer, wfStringsEditor, wfSimpleDataEditor, wfFormatParserDefU, 
  LazarusPackageIntf;
...
begin
  ...
  RegisterUnit('wfPoolConnections', @wfPoolConnections.Register);
